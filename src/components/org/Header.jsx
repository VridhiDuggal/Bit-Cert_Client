...
import { selectUnreadCount } from '../../features/orgSettings/orgSettingsSelectors';
import { fetchUnreadCount } from '../../features/orgSettings/orgSettingsThunks';
...
export function Header({ title, subtitle }) {
  ...
  return (
    <header style={{
      ...
      <button
        onClick={() => navigate('/org/settings?tab=notifications')}
        title="Notifications"
        style={{
          position: 'relative',
          background: 'none',
